...
#
# copyright 2026 Quantum Analytics Research, LLC
# Author: H. Carvey, keydet89@yahoo.com
#-----------------------------------------------------------
package comdlg32_tln;
use strict;
use Time::Local;
...
sub getShortDescr {
	return "Gets contents of user's ComDlg32 key (TLN)";
}
sub getDescr{}
sub getRefs {}
...
sub pluginmain {
	my $class = shift;
	my $ntuser = shift;
	::logMsg("Launching comdlg32_tln v.".$VERSION);
